...
In plots, variations in the estimated intensity function suggest that the bird point intensity is not uniform across different levels of the covariates (elevation, water, hfi and forest cover).
```{r}
